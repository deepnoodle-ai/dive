...
// ResponseItemType represents the type of response item.
...
const (
	...
	// ResponseItemTypeToolCall indicates a tool call is starting.
	ResponseItemTypeToolCall ResponseItemType = "tool_call"

	// ResponseItemTypeToolCallResult indicates a tool call result is available.
	ResponseItemTypeToolCallResult ResponseItemType = "tool_call_result"

	// ResponseItemTypeModelEvent indicates an event was generated by the LLM.
