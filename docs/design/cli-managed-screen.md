...
| Input                                             | Action                                                          | Notes                                                                                                                                                                                    |
| ------------------------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Wheel up / down                                   | Scroll 1 line                                                   | Any button-reporting mode (A3); `MouseScroll` events. Three is the pager convention but overshoots badly on a trackpad, which delivers notches continuously                              |
