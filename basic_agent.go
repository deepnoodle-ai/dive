...
// func NewAgent(spec AgentSpec) *BasicAgent {
// 	if spec.Model == "" {
...
// func (a *BasicAgent) Backstory() string {
// 	return a.backstory
// }

// func (a *BasicAgent) Goal() string {
// 	return a.goal
// }

// func (a *BasicAgent) History() []TaskResult {
// 	return a.history
// }

// func (a *BasicAgent) Team() *Team {
// 	return a.team
// }

// func (a *BasicAgent) SetTeam(team *Team) {
// 	a.team = team
// }

// func (a *BasicAgent) Subordinates() []string {
// 	return a.subordinates
// }

// func (a *BasicAgent) InterpolateInputs(input any) error {
// 	var err error
...
// func (a *BasicAgent) respond(ctx context.Context, messages ...*llm.Message) (*llm.Response, error) {
// 	return nil, errors.New("not implemented")
// }

// func (a *BasicAgent) ExecuteTask(ctx context.Context, task *Task, deps []TaskResult) TaskResult {
...
// func (a *BasicAgent) buildTaskPrompt(task *Task, deps []TaskResult) (string, error) {
// 	taskPrompt, err := interpolateTemplate(
// 		"task",
// 		taskTemplate,
// 		map[string]any{
// 			"BasicAgent":   &AgentTemplateProxy{BasicAgent: a},
// 			"Task":         task,
// 			"Dependencies": deps,
...
// func (a *BasicAgent) SystemPrompt() (string, error) {
